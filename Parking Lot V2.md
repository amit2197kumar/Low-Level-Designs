...
4. Parking floor contains multiple parking slots which are of different types. (HANDICAPPED, COMPACT, LARGE, MOTORBIKE, ELECTRIC)
...
10. Admin shoul be able to add parking slots to the floor.
11. Admin should be able to remove a slot.
12. Admin should be able to add etrance and exit panels.
...
### Classes related to Parking Spot
...
In our Parking Lot there can be many EntrancePanel. EntrancePanel Can be added or removed by Administration.
Parking Ticket is assigned at an EntrancePanel, hence getParkingTicket() is an important functionality of this class.
...
At ExitPanel we need to do 2 things:

1. Free the parking Spot that was occupied by the current vehicle exiting.
2. Take the parking ticket, get the change that the customer need to pay.
...
Administration staff can add Add/Remove Parking floors.
...
class ParkingFloor {
    ...
    */
    ...
    public boolean isFloorFull() {
		...
		/*
		About Java BitSet:
		1. https://www.geeksforgeeks.org/bitset-class-java-set-1/
		2. https://www.geeksforgeeks.org/bitset-class-methods-java-examples-set-2/
		*/
...
This is make class, whose INSTANCE will be accessed by the admin to find and assign a parking spot. Later free up that parking spot.
...
An Admin can : addParkingFloor(), addParkingSpot(), addEntrancePanel(), addExitPanel()
...
Complete Code : /Code/[Parking Lot LLD.java](https://github.com/kumar2197/OOPS-LLD/blob/master/Code/Parking%20Lot%20LLD.java)

## Reference:

1. [Design a Parking Lot- Machine coding - Object Oriented Design - LLD](https://youtu.be/nnpT0WXifLk) (Bala G)
2. [Parking Lot Design | Object Oriented Design Interview Question](https://youtu.be/tVRyb4HaHgw) (Think Software)
